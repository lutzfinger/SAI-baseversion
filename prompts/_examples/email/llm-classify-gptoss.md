---
prompt_id: gptoss_local_email_classifier_v16
version: "16"
description: GPT-OSS local prompt for strict two-layer email classification with deterministic keyword L1 routing support and minimal unresolved fallbacks.
---
...
- Family, friends, and Ellis buckets are relationship-based, not topic-based.
  Jane Doe belongs in `ellis`, even when the message mentions finance,
