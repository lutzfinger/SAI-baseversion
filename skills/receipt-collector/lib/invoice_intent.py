...
hello@lutzfinger.com); REJECT -> delete the unsent draft; ambiguous -> ask y/n.
...
CC_ADDRESS = "hello@lutzfinger.com"
...
def _parse_from(header: str) -> tuple[str, str]:
    """'Gregory P La Blanc <lablanc@berkeley.edu>' -> ('Gregory P La Blanc',
    'lablanc@berkeley.edu'). A bare address returns ('', address)."""
