"""Graph-backed worker for deeper investigation of ambiguous personal emails."""
...
from app.connectors.gmail_history import GmailHistoryConnector, parse_extra_gmail_token_paths
...
from app.graphs.contact_investigation import (
    ContactInvestigationRuntimeContext,
    ContactInvestigationStateGraphRuntime,
)
...
class ContactInvestigationWorker:
    """Investigate `Other` emails with deeper enrichment."""
    ...
    def investigate_contacts(
        ...
        *,
        ...
        runtime = ContactInvestigationStateGraphRuntime(
...
def _tool_or_raise(
    tool_definitions: list[WorkflowToolDefinition], kind: str
