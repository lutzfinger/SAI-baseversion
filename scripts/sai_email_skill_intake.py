...
`hello@lutzfinger.com`), TO the SAI address (e.g. `sai@lutzfinger.com`),
...
-----
    ...
    python -m scripts.sai_email_skill_intake \\
        --inbound sai@lutzfinger.com \\
        --operator hello@lutzfinger.com \\
...
def main() -> int:
    ...
    p.add_argument("--inbound", required=True,
                   help="The inbound SAI email address (e.g. sai@lutzfinger.com).")
    p.add_argument("--operator", required=True,
                   help="The operator email address (e.g. hello@lutzfinger.com). "
